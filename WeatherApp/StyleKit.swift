...
//  WeatherApp
//
//  Created by Juan Gestal on 3/9/18.
...
public class StyleKit : NSObject {
    ...
    @objc dynamic public class func drawTermometer(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 160, height: 320), resizing: ResizingBehavior = .aspectFit, dayTheme: Bool = false, termometerDegrees: CGFloat = 57, termometerCelsius: Bool = true) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        let termometer40CelsiusText = termometerCelsius ? "40" : "104"
        let termometer30CelsiusText = termometerCelsius ? "30" : "86"
        let termometer20CelsiusText = termometerCelsius ? "20" : "68"
        let termometer10CelsiusText = termometerCelsius ? "10" : "50"
        let termometerUnits = termometerCelsius ? "°C" : "°F"
        ...
        context.saveGState()
        context.clip(to: text4Rect)
        termometer10CelsiusText.draw(in: CGRect(x: text4Rect.minX, y: text4Rect.minY + (text4Rect.height - text4TextHeight) / 2, width: text4Rect.width, height: text4TextHeight), withAttributes: text4FontAttributes)
        context.restoreGState()
        ...
        context.saveGState()
        context.clip(to: textRect)
        termometer20CelsiusText.draw(in: CGRect(x: textRect.minX, y: textRect.minY + (textRect.height - textTextHeight) / 2, width: textRect.width, height: textTextHeight), withAttributes: textFontAttributes)
        context.restoreGState()
        ...
        context.saveGState()
        context.clip(to: text2Rect)
        termometer30CelsiusText.draw(in: CGRect(x: text2Rect.minX, y: text2Rect.minY + (text2Rect.height - text2TextHeight) / 2, width: text2Rect.width, height: text2TextHeight), withAttributes: text2FontAttributes)
        context.restoreGState()
        ...
        context.saveGState()
        context.clip(to: text3Rect)
        termometer40CelsiusText.draw(in: CGRect(x: text3Rect.minX, y: text3Rect.minY + (text3Rect.height - text3TextHeight) / 2, width: text3Rect.width, height: text3TextHeight), withAttributes: text3FontAttributes)
        context.restoreGState()
        ...
        //// Text 5 Drawing
        let text5Rect = CGRect(x: 6, y: 9, width: 40, height: 48)
        let text5Style = NSMutableParagraphStyle()
        ...
        context.saveGState()
        context.clip(to: text5Rect)
        termometerUnits.draw(in: CGRect(x: text5Rect.minX, y: text5Rect.minY + (text5Rect.height - text5TextHeight) / 2, width: text5Rect.width, height: text5TextHeight), withAttributes: text5FontAttributes)
        context.restoreGState()
    ...
    @objc dynamic public class func drawSquareButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 151, height: 152), resizing: ResizingBehavior = .aspectFit, dayTheme: Bool = false) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 125.53, y: 37.7))
        bezierPath.addCurve(to: CGPoint(x: 118.31, y: 26.89), controlPoint1: CGPoint(x: 125.53, y: 32.97), controlPoint2: CGPoint(x: 122.68, y: 28.7))
        bezierPath.addCurve(to: CGPoint(x: 105.57, y: 29.43), controlPoint1: CGPoint(x: 113.94, y: 25.08), controlPoint2: CGPoint(x: 108.91, y: 26.08))
        bezierPath.addLine(to: CGPoint(x: 99.45, y: 35.54))
        bezierPath.addLine(to: CGPoint(x: 103.89, y: 39.99))
        bezierPath.addCurve(to: CGPoint(x: 103.89, y: 43.54), controlPoint1: CGPoint(x: 104.88, y: 40.97), controlPoint2: CGPoint(x: 104.88, y: 42.56))
        bezierPath.addCurve(to: CGPoint(x: 100.34, y: 43.54), controlPoint1: CGPoint(x: 102.91, y: 44.53), controlPoint2: CGPoint(x: 101.32, y: 44.53))
        bezierPath.addLine(to: CGPoint(x: 95.89, y: 39.1))
        bezierPath.addLine(to: CGPoint(x: 84.36, y: 50.63))
        bezierPath.addLine(to: CGPoint(x: 88.81, y: 55.08))
        bezierPath.addCurve(to: CGPoint(x: 88.81, y: 58.63), controlPoint1: CGPoint(x: 89.79, y: 56.06), controlPoint2: CGPoint(x: 89.79, y: 57.65))
        bezierPath.addCurve(to: CGPoint(x: 85.25, y: 58.63), controlPoint1: CGPoint(x: 87.82, y: 59.61), controlPoint2: CGPoint(x: 86.23, y: 59.61))
        bezierPath.addLine(to: CGPoint(x: 80.81, y: 54.19))
        bezierPath.addLine(to: CGPoint(x: 69.28, y: 65.72))
        bezierPath.addLine(to: CGPoint(x: 73.72, y: 70.16))
        bezierPath.addCurve(to: CGPoint(x: 73.72, y: 73.72), controlPoint1: CGPoint(x: 74.7, y: 71.14), controlPoint2: CGPoint(x: 74.7, y: 72.74))
        bezierPath.addCurve(to: CGPoint(x: 70.16, y: 73.72), controlPoint1: CGPoint(x: 72.74, y: 74.7), controlPoint2: CGPoint(x: 71.14, y: 74.7))
        bezierPath.addLine(to: CGPoint(x: 65.72, y: 69.28))
        bezierPath.addLine(to: CGPoint(x: 54.19, y: 80.81))
        bezierPath.addLine(to: CGPoint(x: 58.63, y: 85.25))
        bezierPath.addCurve(to: CGPoint(x: 58.63, y: 88.81), controlPoint1: CGPoint(x: 59.61, y: 86.23), controlPoint2: CGPoint(x: 59.61, y: 87.82))
        bezierPath.addCurve(to: CGPoint(x: 55.07, y: 88.81), controlPoint1: CGPoint(x: 57.65, y: 89.79), controlPoint2: CGPoint(x: 56.06, y: 89.79))
        bezierPath.addLine(to: CGPoint(x: 50.63, y: 84.36))
        bezierPath.addLine(to: CGPoint(x: 39.1, y: 95.89))
        bezierPath.addLine(to: CGPoint(x: 43.54, y: 100.34))
        bezierPath.addCurve(to: CGPoint(x: 43.54, y: 103.89), controlPoint1: CGPoint(x: 44.53, y: 101.32), controlPoint2: CGPoint(x: 44.53, y: 102.91))
        bezierPath.addCurve(to: CGPoint(x: 39.99, y: 103.89), controlPoint1: CGPoint(x: 42.56, y: 104.88), controlPoint2: CGPoint(x: 40.97, y: 104.88))
        bezierPath.addLine(to: CGPoint(x: 35.54, y: 99.45))
        bezierPath.addLine(to: CGPoint(x: 29.43, y: 105.57))
        bezierPath.addCurve(to: CGPoint(x: 26.89, y: 118.31), controlPoint1: CGPoint(x: 26.08, y: 108.91), controlPoint2: CGPoint(x: 25.08, y: 113.94))
        bezierPath.addCurve(to: CGPoint(x: 37.7, y: 125.53), controlPoint1: CGPoint(x: 28.7, y: 122.68), controlPoint2: CGPoint(x: 32.97, y: 125.53))
        bezierPath.addLine(to: CGPoint(x: 113.84, y: 125.53))
        bezierPath.addCurve(to: CGPoint(x: 122.11, y: 122.11), controlPoint1: CGPoint(x: 116.94, y: 125.53), controlPoint2: CGPoint(x: 119.92, y: 124.3))
        bezierPath.addCurve(to: CGPoint(x: 125.54, y: 113.84), controlPoint1: CGPoint(x: 124.3, y: 119.91), controlPoint2: CGPoint(x: 125.54, y: 116.94))
        bezierPath.addLine(to: CGPoint(x: 125.53, y: 37.7))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 102.14, y: 102.14))
        bezierPath.addLine(to: CGPoint(x: 65.94, y: 102.14))
        bezierPath.addLine(to: CGPoint(x: 102.14, y: 65.94))
        bezierPath.addLine(to: CGPoint(x: 102.14, y: 102.14))
        bezierPath.close()
        indicatorColor.setFill()
        bezierPath.fill()
